...
Comme d'habitude, vous pouvez voir tout le code source pour cela sur mon GitHub [Ici.](https://github.com/scottgal/mostlylucidweb/blob/main/Umami.Net.Test/UmamiBackgroundSenderTests.cs).
